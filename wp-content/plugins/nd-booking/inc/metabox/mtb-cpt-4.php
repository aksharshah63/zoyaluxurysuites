...
function nd_booking_meta_box_save_cpt_4( $post_id )
{
    ...
    $nd_booking_meta_box_cpt_4_phone = sanitize_meta( 'nd_booking_meta_box_cpt_4_phone',$_POST['nd_booking_meta_box_cpt_4_phone'],'post' );
    if ( isset( $nd_booking_meta_box_cpt_4_phone ) ) { 
        if ( $nd_booking_meta_box_cpt_4_phone != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_phone' , $nd_booking_meta_box_cpt_4_phone );      
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_phone' );
        }  
    }

    $nd_booking_meta_box_cpt_4_address = sanitize_meta( 'nd_booking_meta_box_cpt_4_address',$_POST['nd_booking_meta_box_cpt_4_address'],'post' );
    if ( isset( $nd_booking_meta_box_cpt_4_address ) ) { 
        if ( $nd_booking_meta_box_cpt_4_address != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_address' , $nd_booking_meta_box_cpt_4_address );       
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_address' );
        }  
    }

    $nd_booking_meta_box_cpt_4_city = sanitize_meta( 'nd_booking_meta_box_cpt_4_city',$_POST['nd_booking_meta_box_cpt_4_city'],'post' );
    if ( isset( $nd_booking_meta_box_cpt_4_city ) ) { 
        if ( $nd_booking_meta_box_cpt_4_city != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_city' , $nd_booking_meta_box_cpt_4_city );      
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_city' );
        } 
    }

    $nd_booking_meta_box_cpt_4_state = sanitize_meta( 'nd_booking_meta_box_cpt_4_state',$_POST['nd_booking_meta_box_cpt_4_state'],'post' );
    if ( isset( $nd_booking_meta_box_cpt_4_state ) ) { 
        if ( $nd_booking_meta_box_cpt_4_state != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_state' , $nd_booking_meta_box_cpt_4_state );       
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_state' );
        }   
    }

    $nd_booking_meta_box_cpt_4_email = sanitize_meta( 'nd_booking_meta_box_cpt_4_email',$_POST['nd_booking_meta_box_cpt_4_email'],'post' );
    if ( isset( $nd_booking_meta_box_cpt_4_email ) ) { 
        if ( $nd_booking_meta_box_cpt_4_email != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_email' , $nd_booking_meta_box_cpt_4_email );      
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_email' );
        }     
    }

    $nd_booking_meta_box_cpt_4_color = sanitize_hex_color( $_POST['nd_booking_meta_box_cpt_4_color'] );
    if ( isset( $nd_booking_meta_box_cpt_4_color ) ) { 
        if ( $nd_booking_meta_box_cpt_4_color != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_color' , $nd_booking_meta_box_cpt_4_color );     
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_color' );
        }  
    }

    $nd_booking_meta_box_cpt_4_stars = sanitize_option( 'nd_booking_meta_box_cpt_4_stars', $_POST['nd_booking_meta_box_cpt_4_stars'] );
    if ( isset( $nd_booking_meta_box_cpt_4_stars ) ) { 
        if ( $nd_booking_meta_box_cpt_4_stars != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_stars' , $nd_booking_meta_box_cpt_4_stars );         
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_cpt_4_stars' );
        } 
    }

    //page settings : sanitize and validate
    $nd_booking_meta_box_image_cpt_4 = esc_url_raw( $_POST['nd_booking_meta_box_image_cpt_4'] );
    if ( isset( $nd_booking_meta_box_image_cpt_4 ) ) { 
        if ( $nd_booking_meta_box_image_cpt_4 != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_image_cpt_4' , $nd_booking_meta_box_image_cpt_4 );      
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_image_cpt_4' );
        }   
    }

    $nd_booking_meta_box_image_cpt_4_position = sanitize_option( 'nd_booking_meta_box_image_cpt_4_position', $_POST['nd_booking_meta_box_image_cpt_4_position'] );
    if ( isset( $nd_booking_meta_box_image_cpt_4_position ) ) { 
        if ( $nd_booking_meta_box_image_cpt_4_position != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_image_cpt_4_position' , $nd_booking_meta_box_image_cpt_4_position );        
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_image_cpt_4_position' );
        }   
    }

    $nd_booking_meta_box_page_layout_cpt_4 = sanitize_option( 'nd_booking_meta_box_page_layout_cpt_4', $_POST['nd_booking_meta_box_page_layout_cpt_4'] );
    if ( isset( $nd_booking_meta_box_page_layout_cpt_4 ) ) {
        if ( $nd_booking_meta_box_page_layout_cpt_4 != '' ) {
            update_post_meta( $post_id, 'nd_booking_meta_box_page_layout_cpt_4' , $nd_booking_meta_box_page_layout_cpt_4 );          
        }else{
            delete_post_meta( $post_id, 'nd_booking_meta_box_page_layout_cpt_4' );
        }    
    }
