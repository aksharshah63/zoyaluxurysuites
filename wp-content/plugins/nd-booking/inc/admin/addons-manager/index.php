         ...
         <!--START-->
          <div class="nd_booking_section">
            ...
            <div class="nd_booking_width_60_percentage nd_booking_padding_20 nd_booking_box_sizing_border_box nd_booking_float_left">
              ...
              <div class="nd_booking_section nd_booking_height_20"></div>
              <label class="nd_booking_section"><input <?php if( get_option('nd_booking_alert_msg_enable') == 1 ) { echo 'checked="checked"'; } ?> name="nd_booking_alert_msg_enable" type="checkbox" value="1"> <?php _e('Alert Messages','nd-booking'); ?></label>
          ...
          <div class="nd_booking_section">
            ...
            <div class="nd_booking_width_60_percentage nd_booking_padding_20 nd_booking_box_sizing_border_box nd_booking_float_left">
              ...
              <div class="nd_booking_section nd_booking_height_20"></div>
              <label class="nd_booking_section"><input <?php if( get_option('nd_booking_branch_select_enable') == 1 ) { echo 'checked="checked"'; } ?> name="nd_booking_branch_select_enable" type="checkbox" value="1"> <?php _e('Branch Select Filter','nd-booking'); ?></label>
              <div class="nd_booking_section nd_booking_height_20"></div>
              <label class="nd_booking_section"><input <?php if( get_option('nd_booking_info_price_enable') == 1 ) { echo 'checked="checked"'; } ?> name="nd_booking_info_price_enable" type="checkbox" value="1"> <?php _e('Price Details on Button Hover','nd-booking'); ?></label>
          ...
          <div class="nd_booking_section">
            <div class="nd_booking_width_40_percentage nd_booking_padding_20 nd_booking_box_sizing_border_box nd_booking_float_left">
              <h2 class="nd_booking_section nd_booking_margin_0"><?php _e('Single','nd-booking'); ?> <span style="text-transform: capitalize;"><?php echo nd_booking_get_slug('singular'); ?></span></h2>
              <p class="nd_booking_color_666666 nd_booking_section nd_booking_margin_0 nd_booking_margin_top_10"><?php _e('Manage your addons on single','nd-booking'); ?> <?php echo nd_booking_get_slug('singular'); ?> <?php _e('page','nd-booking'); ?></p>
            </div>
            <div class="nd_booking_width_60_percentage nd_booking_padding_20 nd_booking_box_sizing_border_box nd_booking_float_left">
              ...
              <div class="nd_booking_section nd_booking_height_20"></div>
              <label class="nd_booking_section"><input <?php if( get_option('nd_booking_similar_rooms_enable') == 1 ) { echo 'checked="checked"'; } ?> name="nd_booking_similar_rooms_enable" type="checkbox" value="1"> <?php _e('Similar','nd-booking'); ?> <span style="text-transform: capitalize;"><?php echo nd_booking_get_slug('plural'); ?></span></label>
              <div class="nd_booking_section nd_booking_height_20"></div>
